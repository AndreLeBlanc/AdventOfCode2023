...
test("day 7, part 1", () => {
  expect(day7.part1()).toBe("251121738");
});

test("day 7, part 2", () => {
  expect(day7.part2()).toBe("251421071");
});

test("day 8, part 1", () => {
  expect(day8.part1()).toBe("19637");
});

test("day 8, part 2", () => {
  expect(day8.part2()).toBe("8811050362409");
});

test("day 9, part 1", () => {
  expect(day9.part1()).toBe("1581679977");
});
